...
import { ShoppingCart, User, Search, Menu, X, Home, Grid3x3 } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 border-b border-ink-100 bg-white/90 backdrop-blur-lg">
        <div className="container-silora">
          <div className="flex h-16 items-center gap-3">
            ...
            <Link to="/" onClick={onLogoTap} className="flex items-center gap-1.5 shrink-0 select-none tap-highlight">
        ...
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-72 max-w-[85%] bg-white shadow-card-hover animate-slide-up p-4 overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <Link to="/" onClick={onLogoTap} className="text-xl font-extrabold tracking-tight text-ink-900 select-none">
                SIL<span className="text-primary-600">ORA</span>
              </Link>
        ...
        <div className="container-silora py-12">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div>
              ...
              <ul className="space-y-<dyad-write path="src/layouts/StoreLayout.tsx" description="Complete implementation of StoreLayout with secret 5-tap gesture on the SILORA logo">
import { useState, useEffect, type ReactNode } from 'react';
import { Link, navigate, useRoute } from '@/components/router/Router';
import { ShoppingCart, User, Search, Menu, X, Home, Grid3x3 } from 'lucide-react';
import { useCart } from '@/contexts/CartContext';
